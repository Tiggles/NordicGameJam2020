...
function draw_garden_menu()
    ...
    love.graphics.draw(coin, 200, 30, 0, 2, 2)
    love.graphics.draw(coin, 200, 100, 0, 2, 2)
    love.graphics.draw(coin, 200, 170, 0, 2, 2)
    love.graphics.draw(coin, 200, 240, 0, 2, 2)
    love.graphics.draw(coin, 200, 310, 0, 2, 2)
